...
// Might Choose Different means for mode selection

export const realms_major_modes = [
  modes.major,
  modes.lydian,
  modes.mixolydian,
  modes.pentatonic,
...
export const realms_minor_modes = [
  modes.naturalminor,
  modes.dorian,
  modes.minor_pentatonic,
  modes.minor_hexatonic,
]

export const mumu_modes = [major_modes, minor_modes]
export const realms_modes = [major_modes, minor_modes]
